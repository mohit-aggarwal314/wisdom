      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="container">
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-4"><b>Birth Date</b></div>
            ...
            <div class="row form_img bg-light">
              ...
              <div class="col-4">
                <input type="text" name="phone_code" value="+91" class="input_width" required autocomplete="off"><br>
                <span>Phone Number</span>
              </div>
              <div class="col-4">
                <input type="text" name="phone_num" value="+91" class="input_width" required autocomplete="off"> <br>
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-4"><b>How were you referred to us ? </b>
                <span class="form-required">* </span>
              </div>
              <div class="col-4" name="referred">
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-4"><b>Upload Resume: </b>
              </div>
              <div class="col-8">
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-4"><b>Describe your skills: </b>
                <span class="form-required">* </span>
              </div>
              <div class="col-8">
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-12"><b>Training or Certifications: </b></div>
              <div class="col-12">&nbsp;</div>
              <div class="col-12">
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-12"><b>References</b> Please list two (2) references that are familiar with
                your work life.
              </div>
            </div>
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-12"><b>Reference 1</b> </div>
            </div>
            ...
            <div class="row form_img bg-light">
              ...
              <div class="col-4">
                <input type="text" name="re_phone_code" value="+91" class="input_width" required autocomplete="off"><br>
                <span>Phone Number</span>
              </div>
              <div class="col-4">
                <input type="text" name="re_phone_num" value="+91" class="input_width" required autocomplete="off"><br>
                <span>Phone Number</span>
              </div>
            </div>
            ...
            <div class="row form_img bg-light">
              <div class="col-12">&nbsp;</div>
              <div class="col-4"><b>Total Years Of Experience: </b>
                <span class="form-required">* </span>
              </div>
              <div class="col-8">
            ...
            <div class="row form_img bg-light">
              <div class="col-12"><b>Reference 2</b> </div>
            </div>
            ...
            <div class="row form_img bg-light">
              ...
              <div class="col-4">
                <input type="text" name="ref_phone_code" value="+91" class="input_width" required autocomplete="off"><br>
                <span> Phone Number </span>
              </div>
              <div class="col-4">
                <input type="text" name="ref_phone_num" value="+91" class="input_width" required autocomplete="off"><br>
                <span>Alternate Number</span>
              </div>
            </div>
