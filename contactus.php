  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="circleiconq">
          <a href="" class="callicon"><i class="fas fa-phone-alt"></i></a> <br><br>
          <span class="callnumber">+91 8010961313</span>
        </div>
      </div>
      <div class="col-md-4">
        <div class="circleiconq">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="form-containerss">
          <h3 class="title">Any Queries? Write to us:</h3>
          <form class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <textarea name="message" rows="5" cols="65" class="textareasa" placeholder="Enter Message" autocomplete="off" required></textarea>
            </div>
