...
<!--<h2 class="navbottomtext">Uniform</h2>-->
<div class="navbotparagraph">
  <h6 class="icontext"><a href="index.php"><i class="fas fa-home home ddd"></a></i> &nbsp;| &nbsp; Uniform</h6>
</div>
</section>
...
<section class="unifo">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <img src="img/uniform.jpg" class="uniformingg" alt="">
      </div>
    </div>
  </div>
</section>
